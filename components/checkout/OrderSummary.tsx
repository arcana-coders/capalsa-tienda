...
function CardSubmitButton({ label, isProcessing }: { label: string; isProcessing: boolean }) {
  ...
  return (
    <button
      ...
      className="w-full py-5 bg-[#00386c] hover:bg-[#1a4f8b] disabled:opacity-60 disabled:cursor-not-allowed text-white font-black rounded-2xl text-sm transition-all duration-200 ease-out active:scale-95 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
    >
      {isProcessing ? (
        <>
